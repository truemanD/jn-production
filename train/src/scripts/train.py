...
pickle.dump(X_test, open('predict/data/test_dataset.pkl', 'wb'))
pickle.dump(y_test, open('predict/data/test_classes.pkl', 'wb'))
pickle.dump(y_train, open('train/data/train_classes.pkl', 'wb'))
pickle.dump(X_train, open('train/data/train_dataset.pkl', 'wb'))
rfc = RandomForestClassifier(n_estimators=200)
rfc.fit(X_train, y_train)
#model=rfc
pred_rfc = rfc.predict(X_test)
filename = 'predict/data/rfc.pkl'
